...
$pCorpSeq = is_null($_REQUEST["corpSeq"])? "25" : $_REQUEST["corpSeq"];
...
$query = <<<EOD
  ...
  left join CODE as CORP_TYPE on INFO.CORP_TYPE = CORP_TYPE.CD and CORP_TYPE.GRP_CD = 'CORP_TYPE'
  left join CODE as COMP_KIND on INFO.COMP_KIND = COMP_KIND.CD and COMP_KIND.GRP_CD = 'COMP_KIND'
  left join CODE as BIZ_SECT on INFO.BIZ_SECT = BIZ_SECT.CD and BIZ_SECT.GRP_CD = 'BIZ_SECT'
